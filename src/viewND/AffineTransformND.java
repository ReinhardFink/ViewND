...
public class AffineTransformND {
	 ...
	 * 
	 * [ x'] [ m00 m01 m02 ] [ x ] [ m00x + m01y + m02z ] [ y'] = [ m10 m11 m12
	 * ] [ y ] = [ m10x + m11y + m12z ] [ z'] [ m20 m21 m22 ] [ z ] [ m20x +
	 * m21y + m22z ]
	 */
	 ...
	 * 
	 * [ 1   0   0   0  ] [x1] = [        x1          ] 
	 * [ 0  cos  0 -sin ] [x2] = [x2 * cos - x4 * sin ] 
	 * [ 0   0   1   0  ] [x3] = [        x3          ] 
	 * [ 0  sin  0  cos ] [x4] = [x2 * sin + x4 * cos ]
	 */
	...
	public PointND transformPointND(PointND p) {
		PointND newPoint = new PointND();
		for (int line = 0; line < CONSTANTS.n; line++) {
			double sum = 0;
			for (int i = 0; i < CONSTANTS.n; i++)
				sum += m[line][i] * p.getXi(i);
